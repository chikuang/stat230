...
With multiple random variables, we are even more interested in \textbf{functions} of such variables. For example, Let $A, M, F$ be the random variables for your assignment, midterm and final grades respectively. Then, it's natural to consider the overall grade $G = g(A,M,F)$ as a function of random variables $A, M, F$.
